...
$p_cust_id_cliente = '570197';
$p_key             = '678451738354c28c4552c89bd89de3ef1c719f1a';
...
$numOrder = $_REQUEST['x_id_invoice']; // Este valor es un ejemplo se debe reemplazar con el número de orden que tiene registrado en su sistema
$valueOrder = $_REQUEST['x_amount'];  // Este valor es un ejemplo se debe reemplazar con el valor esperado de acuerdo al número de orden del sistema del comercio
